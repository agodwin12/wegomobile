...
class _DeliveryActiveExpressScreenState
  ...
  Future<void> _captureProofPhoto(StateSetter setDS) async {
    try {
      final picked = await _picker.pickImage(
          source: ImageSource.camera, maxWidth: 1920, imageQuality: 80);
      if (picked == null) return;
      setDS(() => _uploadingProof = true);
      final request = http.MultipartRequest(
        'POST', Uri.parse('${AppConfig.apiBaseUrl}/upload/package-photo'),
      )
        ..headers['Authorization'] = 'Bearer $_accessToken'
        ..files.add(await http.MultipartFile.fromPath(
      ...
      if (mounted) setDS(() => _uploadingProof = false);
    }
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: _uploadingProof ? null : () => _captureProofPhoto(setDS),
