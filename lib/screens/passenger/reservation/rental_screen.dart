              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Location + seats row
                    Row(children: [
                      const Icon(Icons.location_on_rounded, size: 11, color: AppColors.textLight),
      ...
      SizedBox(height: 360,
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Container(width: 100, height: 100,
                ...
                child: const Icon(Icons.car_rental_rounded, size: 44, color: AppColors.textLight)),
            const SizedBox(height: 24),
      ...
      child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        if (name != null) ...[
          ...
          Container(
              ...
              child: Text(name.split(' ').first, style: const TextStyle(fontSize: 9,
